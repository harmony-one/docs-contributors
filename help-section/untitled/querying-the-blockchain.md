...
## Querying the blockchain <a id="querying-the-blockchain"></a>

The `hmy` provides several subcommands under the `blockchain` subcommand which let you query the blockchain.

## Targeting Specific Shards <a id="targeting-specific-shards"></a>
...
$ hmy --node="https://api.s0.p.hmny.io" blockchain transaction-receipt ${hash}
{
  "id": "0",
  "jsonrpc": "2.0",
  "result": null
...
`--node="https://api.s1.p.hmny.io"` vs `--node="https://api.s0.p.hmny.io"`
